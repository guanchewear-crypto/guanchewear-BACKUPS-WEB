...
export default function FAQSection() {
  ...
  return (
    <section id="faq" className="scroll-mt-16 bg-bg-secondary px-5 py-24 text-text-primary md:px-10 md:py-36" aria-labelledby="faq-title">
      <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[.85fr_1.15fr] lg:gap-24">
        <div>
          <p className="label-section mb-5 text-text-muted">FAQ</p>
        ...
        <div>
          {faqData.map((item, index) => {
            ...
            return <div key={item.question} className="border-t border-border-subtle last:border-b">
